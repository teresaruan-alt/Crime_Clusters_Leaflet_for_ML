...
// Link to GeoJSON
var incomeGeojson = "geojsonOutput5.geojson"
var geojson1;
...
//     // Add min & max
//     var legendInfo = "<h1>WORLD HAPPINESS REPORT</h1>" + "<h2>Happiness Score: </h2>" +
//       "<div class=\"labels\">" +
...
// 		color = [0,10471,48061.5 ,85652 ,123242.5 ,160,833],
// 		labels = [];
...
legend.onAdd = function (map) {
    var div = L.DomUtil.create('div', 'legend');
    div.innerHTML +=  '<img src ="img/marker-icon-orange.png">' + ' ARSON' + '<br>'
    div.innerHTML +=  '<img src ="img/marker-icon-black.png">' + ' ASSAULT' + '<br>'
    div.innerHTML +=  '<img src ="img/marker-icon-grey.png">' + ' BATTERY' + '<br>'
    div.innerHTML +=  '<img src ="img/marker-icon-red.png">' + ' HOMICIDE' + '<br>'
    div.innerHTML +=  '<img src ="img/marker-icon-green.png">' + ' MOTOR VEHICLE THEFT' + '<br>'
    div.innerHTML +=  '<img src ="img/marker-icon-violet.png">' + ' NARCOTICS' + '<br>'
    div.innerHTML +=  '<img src ="img/marker-icon-yellow.png">' + ' ROBBERY' + '<br>'
    div.innerHTML +=  '<img src ="img/marker-icon-blue.png">' + ' THEFT' + '<br>'
